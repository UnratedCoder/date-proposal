...
export default function Home() {
  ...
  return (
    <main className="h-screen w-full flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-slate-950 via-velvet-950 to-slate-950 py-6 px-4 select-none">
        ...
        >
          ...
          <div className="absolute -bottom-2 right-2 z-30">
            <motion.div
              ...
              transition={{ repeat: Infinity, duration: 3.5, ease: "easeInOut" as const, delay: 0.8 }}
      ...
      <div className="w-full max-w-4xl z-10 flex flex-col items-center">
        <AnimatePresence mode="wait">
          ...
          {step === 1 && hasOpenedEnvelope && (
            <StepTransition stepKey="step1" className="w-full flex flex-col items-center">
          ...
          {step === 2 && (
            <StepTransition stepKey="step2" className="w-full flex flex-col items-center">
          ...
          {step === 3 && (
            <StepTransition stepKey="step3" className="w-full flex flex-col items-center">
          ...
          {step === 4 && (
            <StepTransition stepKey="step4" className="w-full flex flex-col items-center">
          ...
          {step === 5 && (
            <StepTransition stepKey="step5" className="w-full flex flex-col items-center">
          ...
          {step === 6 && (
            <StepTransition stepKey="step6" className="w-full flex flex-col items-center">
          ...
          {step === 7 && (
            <StepTransition stepKey="step7" className="w-full flex flex-col items-center">
          ...
          {step === 8 && (
            <StepTransition stepKey="step8" className="w-full flex flex-col items-center">
      ...
      <AnimatePresence>
        {!hasOpenedEnvelope && (
          <EnvelopeOverlay onOpen={handleOpenEnvelope} />
        )}
      </AnimatePresence>
        ...
        <div className="flex flex-wrap items-center justify-center gap-1">
          ...
          <span>
            ...
            <a 
              ...
              className="text-love-400 hover:text-love-500 font-bold underline transition-colors cursor-pointer pointer-events-auto"
            >
              UnratedCoder
            </a>
          </span>
